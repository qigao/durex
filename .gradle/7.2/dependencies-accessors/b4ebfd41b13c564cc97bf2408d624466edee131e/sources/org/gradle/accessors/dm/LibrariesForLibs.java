...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class QuarkusLibraryAccessors extends SubDependencyFactory {
        ...
        public QuarkusLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for platform (io.quarkus.platform:quarkus-bom)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getPlatform() { return create("quarkus.platform"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final WiremockVersionAccessors vaccForWiremockVersionAccessors = new WiremockVersionAccessors(providers, config);
        ...
        /**
         * Returns the group of versions at versions.wiremock
         */
        public WiremockVersionAccessors getWiremock() { return vaccForWiremockVersionAccessors; }

    }

    public static class WiremockVersionAccessors extends VersionFactory  implements VersionNotationSupplier {

        public WiremockVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the version associated to this alias: wiremock (2.31.0)
         * If the version is a rich version and that its not expressible as a
         * single version string, then an empty string is returned.
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> asProvider() { return getVersion("wiremock"); }

            /**
             * Returns the version associated to this alias: wiremock.lanwen (1.3.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getLanwen() { return getVersion("wiremock.lanwen"); }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        public PluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a plugin provider for springdependency to the plugin id 'io.spring.dependency-management'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getSpringdependency() { return createPlugin("springdependency"); }
