...
/**
 * Represents an annotation event handler. To create a custom annotation it is required to create a
 * AnnotationEventHandler implementation too.
 */
public interface AnnotationEventHandler {
  ...
  /**
   * This method should return true in case the requested method matches the annotation handler
   * criteria. It could be the event type, the annotations of the method, or any other property.
   *
   * <p>In case the method doesn't match the handler criteria, return false to make the annotation
   * handler manager ignore that method from this handler.
   *
