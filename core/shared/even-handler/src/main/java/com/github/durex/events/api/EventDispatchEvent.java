...
public class EventDispatchEvent extends Event implements EventCancellable {
  ...
  /**
   * Cancelling this event will prevent the dispatching of the called event. Cause the event is not
   * going to be launched, the event cancellation system is not going to work with it.
   */
