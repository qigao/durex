...
class EventManagerRegisteredListenersListingTest {
  ...
  @Test
  void
      getRegisteredListeners_shouldNotReturnDuplicatedEntries_whenRegisteredListenerHasMultipleHandlers() {
    // Register events
  ...
  @Test
  void
      getRegisteredListeners_shouldReturnDuplicatedEntries_whenRegisteredListenerHasRegisteredTwice() {
    // Register events
    eventManager.registerEvents(new FirstTestListener());
    eventManager.registerEvents(new FirstTestListener());
  ...
  /**
   * This event listener will be used to test registered listeners listing with multiple registered
   * listeners.
   */
